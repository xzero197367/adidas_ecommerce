...
//        }
//        // ✅ FIXED: Updated methods in ReviewRepository.cs

//        // Method to get rejected reviews count
//        public async Task<int> GetRejectedReviewsCountAsync()
//        {
//            // ✅ FIXED: Rejected = IsApproved = false AND IsActive = false AND not deleted
//            return await _context.Reviews
//                .CountAsync(r => !r.IsApproved && !r.IsActive && !r.IsDeleted);
//        }

//        // Method to get pending reviews count  
//        public async Task<int> GetPendingReviewsCountAsync()
//        {
//            // ✅ FIXED: Pending = IsApproved = false AND IsActive = true AND not deleted
//            return await _context.Reviews
//                .CountAsync(r => !r.IsApproved && r.IsActive && !r.IsDeleted);
//        }

//        // ✅ NEW: Method to get approved reviews count
...
//        // ✅ UPDATED: GetFilteredReviewsAsync method with proper status filtering
